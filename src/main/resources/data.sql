...
--     (1, '2026-09-02', '09:00:00', '09:30:00', 'AVAILABLE'),
--     (1, '2026-09-02', '09:30:00', '10:00:00', 'AVAILABLE'),
--     (1, '2026-09-02', '10:00:00', '10:30:00', 'BOOKED'),
--     (2, '2026-09-02', '11:00:00', '11:30:00', 'AVAILABLE'),
--     (2, '2026-09-02', '12:00:00', '12:30:00', 'AVAILABLE'),
--     (3, '2026-09-02', '14:00:00', '14:30:00', 'AVAILABLE'),
--     (3, '2026-09-02', '14:30:00', '15:00:00', 'AVAILABLE'),
--     (4, '2026-09-02', '16:00:00', '16:30:00', 'BOOKED');
--
-- INSERT INTO users (username, password_hash, phone, role, status, created_at) VALUES
...
TRUNCATE TABLE appointments, availability_slots, patients, doctors, departments, users RESTART IDENTITY CASCADE;

INSERT INTO users (username, password_hash, phone, role, status, created_at) VALUES
    ('dr_adel', 'hashed_pass_1', '01000000001', 'DOCTOR', 'ACTIVE', CURRENT_TIMESTAMP),
    ('ahmed_patient', 'hashed_pass_2', '01000000002', 'PATIENT', 'ACTIVE', CURRENT_TIMESTAMP);

INSERT INTO departments (name) VALUES
    ('Cardiology');

INSERT INTO doctors (user_id, department_id, first_name, last_name, specialization) VALUES
    (1, 1, 'Adel', 'Nasim', 'Cardiologist');

INSERT INTO patients (user_id, first_name, last_name, date_of_birth, gender, created_at) VALUES
    (2, 'Ahmed', 'Abdelhalem', '2000-01-15', 'MALE', CURRENT_TIMESTAMP);

INSERT INTO availability_slots (doctor_id, date, start_time, end_time, status) VALUES
    (1, '2026-09-05', '10:00:00', '10:30:00', 'BOOKED'),
    (1, '2026-09-05', '11:00:00', '11:30:00', 'BOOKED');
