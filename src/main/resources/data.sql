...
INSERT INTO users (username, password_hash, phone, role, status, created_at) VALUES
    ...
    ('dr_ahmed',  'pass123_hash', '01044445555', 'DOCTOR', 'ACTIVE', CURRENT_TIMESTAMP),
    ('dr_mostafa',  'pass123_hash', '01044445555', 'DOCTOR', 'ACTIVE', CURRENT_TIMESTAMP);
...
INSERT INTO doctors (user_id, department_id, first_name, last_name, specialization) VALUES
    ...
    (5, 2, 'Mora', 'Ibrahim', 'Pediatric Specialist'),
    (6, 2, 'Mora', 'Ibrahim', 'Pediatric Specialist');
...
INSERT INTO availability_slots (doctor_id, date, start_time, end_time, status) VALUES
                                                                                   ...
                                                                                   (1, '2026-09-11', '09:00:00', '09:30:00', 'AVAILABLE'),
                                                                                   (1, '2026-09-11', '09:30:00', '10:00:00', 'AVAILABLE'),
                                                                                   (1, '2026-09-11', '10:00:00', '10:30:00', 'BOOKED'),
                                                                                   (2, '2026-09-11', '11:00:00', '11:30:00', 'AVAILABLE'),
                                                                                   (2, '2026-09-11', '12:00:00', '12:30:00', 'AVAILABLE'),
                                                                                   (3, '2026-09-11', '14:00:00', '14:30:00', 'AVAILABLE'),
                                                                                   (3, '2026-09-11', '14:30:00', '15:00:00', 'AVAILABLE'),
                                                                                   (4, '2026-09-11', '16:00:00', '16:30:00', 'BOOKED');
...
INSERT INTO patients (user_id, first_name, last_name, date_of_birth, gender, created_at) VALUES
    ...
    (6, 'Ahmed', 'Abdelhalem', '2005-01-01', 'MALE', CURRENT_TIMESTAMP),
    (7, 'Ahmed', 'Abdelrhman', '2005-01-01', 'MALE', CURRENT_TIMESTAMP);
...
INSERT INTO appointments (patient_id, doctor_id, slot_id, status, notes, created_at) VALUES
    ...
    (2, 1, 9, 'PENDING', 'Patient requires urgent cardiac consultation.', CURRENT_TIMESTAMP),
    (2, 1, 10, 'PENDING', 'Patient requires urgent cardiac consultation.', CURRENT_TIMESTAMP),
    (3, 2, 11, 'PENDING', 'Patient requires urgent cardiac consultation.', CURRENT_TIMESTAMP),
    (3, 2, 12, 'PENDING', 'Patient requires urgent cardiac consultation.', CURRENT_TIMESTAMP);